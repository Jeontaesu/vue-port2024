...
export const siteText = [
  {
    ...
    code: 'https://github.com/webstoryboy/port2024-vite',
...
export const portText = [
  ...
  },
  {
    ...
    desc: '이 사이트는 정말 인상적인 포트폴리오입니다. 특히 스무스한 효과와 가로 모드드 높은 퀄리티를 자랑합니다. 디테일과 꼼꼼함이 넘치는 포트폴리오는 개발자의 뛰어난 능력을 엿볼 수 있습니다. GSAP와 React.js를 이용하여 사이트를 표현한 것은 기술적인 능력과 창의성을 강조하는데, 부족함이 없으며, 세심한 코딩과 디테일한 작업으로 그의 개발 감각과 능력이 빛을 발휘한 것 같습니다. ',
    img: port03,
    code: 'https://github.com/YeoDaSeul4355/portfolio',
    view: 'https://portfolio-jjul.web.app/',
    name: '천설* 포트폴리오'
  },
  {
    num: '04',
...
export const contactText = [
  {
    link: 'https://open.kakao.com/o/sLUXxDlg',
    title: 'KAKAO : jeontaesu90'
  },
  {
    link: 'mailto:jeontaesu90@naver.com',
    title: 'mail: JEONTAESU90@NAVER.COM'
  }
]
